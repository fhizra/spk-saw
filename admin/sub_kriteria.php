  ...
  <div class="col-lg-12">
    ...
    <div class="card shadow mt-3 mb-3">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-olive">Data Sub Kriteria</h6>
        <div class="card-body">
          <button class="btn btn-sm btn-info mb-2" data-toggle="modal" data-target="#tambah_bank"><i class="fas fa-plus fa-sm"></i>Tambah Sub Kriteria</button>
          <div class="card-tools float-right" style="width: 280px;">
