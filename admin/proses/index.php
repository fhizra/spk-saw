...
<div class="container-fluid">
	...
	<div class="card shadow mt-3 mb-3">
		...
		<div class="card-body" align="center">
			...
			<br><p class="h5" style="color:	#66CDAA"><b><?php echo $row['keterangan']; ?></b></p><br>
			<table class="table	table-bordered" style="height: 200px; max-height: 200px; max-width: 80%;" id="customers">
				<tr>
				...
				while ($array = mysqli_fetch_array($sqlkriteria)) {
					...
					<td><div align="center"><?php echo $array['bobot_pref']; ?></div></td>
					</tr>
					<?php
					$no++;
				}
