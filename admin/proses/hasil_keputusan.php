	...
	<div class="col-lg-12">
		...
		<div class="card shadow mt-3 mb-3">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-olive">Data Hasil Proses Perhitungan</h6>
			</div>
			<!-- Data 2 -->
			<div class="card-body">
				...
				<div class="table-responsive">
					<table class="table table-bordered">
						...
						<tbody>
							...
							include('../../config/koneksi.php');
							$noo = 1;
							$qq = mysqli_query($konek, "SELECT * FROM hasil a LEFT JOIN alternatif b ON a.id_alternatif=b.id_alternatif WHERE a.id_periode = '$idp' ORDER BY a.id_alternatif");
							...
							?>
								<tr>
									...
									<td style="font-size: 16px; text-align: center"><?php echo round($dd['hasil'],3); ?></td>
			...
			<div class="card shadow mt-3 mb-3">
				<div class="card-header py-3">
					<h6 class="m-0 font-weight-bold text-black">Data Hasil Kesimpulan</h6>
				</div>
				<div class="card-body">
					<table class="table table-bordered">
						<thead>
