...
<div class="container-fluid">
	...
	<div class="card shadow mt-3 mb-3">
		...
		<div class="card-body" align="center">
			<div>
				<h4 class="m-0 font-weight-bold text-black" align="center">Selamat Datang Admin!<img src="../img/rumahzakat.png" width="200px;" align="right"></h4>
			</div><br>
    ...
    <div class="card shadow mt-3 mb-2">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-black">Singkat Tentang Metode SAW</h6>
        </div>
        <div class="card-body">
    ...
    <div class="container-fluid mt-3">
        <div class="card shadow mt-3 mb-2">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-black">Langkah Penggunaan</h6>
            </div>
            <div class="card-body">
                <h7>
