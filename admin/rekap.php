	...
	<div class="col-lg-12">
		...
		<div class="card shadow mt-3 mb-3">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-olive">Rekap Pengambilan Keputusan</h6>
			</div>
			<div class="card-body">
				...
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							...
							<td><a href="proses/index.php?idp=<?php echo $array['id_periode'];?>"><i class="btn btn-info btn-sm"><span class="fas fa-plus-square"></span></i></a></td>
							<td><a href="proses/grafik.php?idp=<?php echo $array['id_periode'];?>"><i class="btn btn-success btn-sm"><span class="fas fa-search"></span></i></a></td>
